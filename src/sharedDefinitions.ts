// These are shared with the mongodb-mobile-client project; I hate having a copy in each, but I
// don't want a hard dependency between them, so I'm not sure how to avoid it
